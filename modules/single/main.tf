...
module "lambda" {
  ...
  create_vol_scan_resource             = var.volume_scanning_deployment == "true" ? true : false
  create_registry_scanning_resource    = var.registry_scanning_deployment != "false" ? true : false
  create_serverless_scanning_resource  = var.serverless_scanning_deployment != "false" ? true : false
...
module "trigger" {
  ...
  registry_scanning_role_arn          = module.lambda.registry_scanning_role_arn
  serverless_scanning_role_arn        = module.lambda.serverless_scanning_role_arn
